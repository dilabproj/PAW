...
class EEGNet(nn.Module):
    def __init__(
        ...
        self.block1.add_module("bnorm_temporal",nn.BatchNorm2d(self.F1, momentum=0.01, affine=True, eps=1e-3))
        ...
        self.block1.add_module("bnorm_1",nn.BatchNorm2d(self.F1 * self.D, momentum=0.01, affine=True, eps=1e-3))
        ...
        self.block2.add_module("bnorm_2",nn.BatchNorm2d(self.F2, momentum=0.01, affine=True, eps=1e-3))
